...
- **【重要】アクション数の厳格な制限**：
  ...
  * {bookmarkCount}個の保存したページが既に存在する場合を除き、**必ず5個以下**にしてください
  * ページを必ず1つ以上提案してください
- **【重要】URLの具体化**：
...
- ただし、検索キーワードやパラメータの変更要求がある場合は例外です：
  * 例：「英語のニュースを日本語に変えて」→ 同じドメインでもsearchKeywordを変更
  * 例：「温泉から観光地に変えて」→ 同じ予約サイトでもsearchKeywordを変更
  * この場合、urlは同じでもsearchKeywordフィールドを更新してください
...
- 修正要求の内容によっては、変更が不要な場合もあります。その場合は空のレスポンスを返してください
